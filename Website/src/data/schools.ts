...
export const schools: School[] = [
  ...
  { name: 'University of Michigan', logo: withBase('/logos/schools/michigan.svg'), alt: 'University of Michigan logo', width: 250, height: 250 },
  { name: 'Chapman University', logo: withBase('/logos/schools/chapman.svg'), alt: 'Chapman University logo', width: 274, height: 28 },
  ...
  { name: 'U.S. Merchant Marine Academy', logo: withBase('/logos/schools/usmma.svg'), alt: 'U.S. Merchant Marine Academy logo', width: 102, height: 100 },
